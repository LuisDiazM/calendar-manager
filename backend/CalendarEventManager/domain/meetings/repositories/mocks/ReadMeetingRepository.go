...
// GetMeetingsByUser provides a mock function with given fields: userId
func (_m *ReadMeetingRepository) GetMeetingsByUser(userId string) (*[]entities.Meetings, error) {
